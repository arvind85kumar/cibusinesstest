        ...
        <div class="container">
          ...
          <div class="row offs3">
            <div class="col-md-4 col-sm-12 col-xs-12">
              <a class="thumb" data-fancybox-group='1' href="<?php echo base_url(); ?>images/page-3_img1_original.jpg">              
                <img class="" src="<?php echo base_url(); ?>images/page-3_img1.jpg" alt="">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
              <a class="thumb" data-fancybox-group='1' href="<?php echo base_url(); ?>images/page-3_img2_original.jpg">              
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
              <a class="thumb" data-fancybox-group='1' href="<?php echo base_url(); ?>images/page-3_img3_original.jpg">              
                <img class="" src="<?php echo base_url(); ?>images/page-3_img3.jpg" alt="">
                <span class='thumb_overlay'></span>
              </a>  
              <p class="lead">
        ...
        <div class="container">
          ...
          <div class="row offs3">
            <div class="col-md-3 col-sm-6 col-xs-12"> 
              <img class="" src="<?php echo base_url(); ?>images/page-3_img4.jpg" alt="">
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">             
          ...
          <div class="row row_offs">
            <div class="col-md-3 col-sm-6 col-xs-12"> 
              <img class="" src="<?php echo base_url(); ?>images/page-3_img6.jpg" alt="">
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">             
              <p class="lead lead_offs2">
                Ut enim ad minim veniam quis
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 clear991"> 
              <img class="" src="<?php echo base_url(); ?>images/page-3_img7.jpg" alt="">
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">             
              <p class="lead lead_offs2">
                Ut enim ad minim veniam quis
